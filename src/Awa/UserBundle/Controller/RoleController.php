...
use Awa\UserBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AwaUserBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("AwaUserBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AwaUserBundle:Role')->find($id);
     ...
     * @Method("PUT")
     * @Template("AwaUserBundle:Role:edit.html.twig")
     */
