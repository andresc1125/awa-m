...
use Awa\BussinessBundle\Form\CurrencyType;
...
class CurrencyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AwaBussinessBundle:Currency')->findAll();
     ...
     * @Method("POST")
     * @Template("AwaBussinessBundle:Currency:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AwaBussinessBundle:Currency')->find($id);
     ...
     * @Method("PUT")
     * @Template("AwaBussinessBundle:Currency:edit.html.twig")
     */
